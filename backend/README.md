...
## Project Structure
    ...
    ├── testapiautodatamod_126178  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_126178`
...
2. Clone this repo and `cd testapiautodatamod_126178`
